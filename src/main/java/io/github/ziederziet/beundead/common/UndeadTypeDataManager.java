            ...
            try {
                ...
                if (unserializedMobEffects != null){
                    ...
                    for (int i = 0; i < mobEffects.length; i++) {
                        Optional<Holder.Reference<MobEffect>> optional = BuiltInRegistries.MOB_EFFECT.getHolder(new ResourceLocation(unserializedMobEffects[i].mobEffectId()));
                ...
                if (data.damageTypes() != null && BeUndead.getServer() != null){
                    ...
                    for (String damageTypeId : data.damageTypes()){
                        ...
                        Optional<Holder.Reference<DamageType>> optional = reg.getHolder(new ResourceLocation(damageTypeId));
                        if (optional.isPresent()){
